...
RUN git clone https://github.com/INN/umbrella-publicsource.git
...
COPY --from=plugins /src/umbrella-publicsource/wp-content/themes/theme-publicsource /usr/src/wordpress/wp-content/themes/theme-publicsource
